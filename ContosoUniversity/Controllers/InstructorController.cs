...
namespace ContosoUniversity.Controllers
{
    public class InstructorController : Controller
    {
        ...
        public ActionResult Edit(int? id)
        {
            ...
            // Eager Loading, can't be done with 'find', so 'where' and 'single' used instead
        ...
        //Reads through all course entities to load list using the view model class
        ...
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        // Gets current Istructor entity from DB using Eager Loading
        ...
        public ActionResult Edit(int? id, string[] selectedCourses)
        {
            ...
            // enables whitelist properties want to include, prvents over-posting
